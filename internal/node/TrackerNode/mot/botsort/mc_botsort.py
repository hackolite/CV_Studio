# -*- coding: utf-8 -*-
"""
Multi-Class BoT-SORT Tracker Wrapper
Wraps the BoT-SORT tracker to handle multi-class object tracking
"""
import numpy as np
from node.TrackerNode.mot.botsort.botsort_tracker import BotSort


class MultiClassBotSORT(object):
    def __init__(
        self,
        max_age=30,
        min_hits=3,
        ...
        """
        Initialize Multi-Class BoT-SORT tracker
