    ...
    def add_node(
        ...
        with dpg.node(
            ...
            with dpg.node_attribute(
                ...
                dpg.add_combo(
                    list(node._threshold_types.keys()),
                    default_value=list(node._threshold_types.keys())[0],
...
class Node(Node):
    ...
    def update(
        ...
        if audio_frame is not None:
            processed_audio = image_process(audio_frame, frame, threshold_type, binary_threshold)
