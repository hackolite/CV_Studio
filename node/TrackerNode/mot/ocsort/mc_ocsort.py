# -*- coding: utf-8 -*-
"""
Multi-Class OC-SORT Tracker Wrapper
Wraps the OC-SORT tracker to handle multi-class object tracking
"""
import numpy as np
from node.TrackerNode.mot.ocsort.ocsort_tracker import OCSort


class MultiClassOCSORT(object):
    def __init__(
        self,
        max_age=30,
        min_hits=3,
        ...
        """
        Initialize Multi-Class OC-SORT tracker
        ...
        Args:
            ...
            delta_t: Time steps for observation-centric momentum (OC-SORT specific)
        """
