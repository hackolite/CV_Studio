...
running end-to-end — from live input to AI inference and visualization. For the **retail,
urbanism, and spatial intelligence** use cases above, prioritize demos that showcase **detection,
