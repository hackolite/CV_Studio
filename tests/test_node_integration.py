...
def test_dl_node_imports():
    ...
    sys.modules['node.DLNode.classification.efficientnet'] = mock.MagicMock()
    sys.modules['node.DLNode.classification.efficientnet.efficientnet'] = mock.MagicMock()
    sys.modules['node.DLNode.classification.mobilenet'] = mock.MagicMock()
    sys.modules['node.DLNode.classification.mobilenet.mobilenet'] = mock.MagicMock()
